    ...
    <Layout>
      <div className="py-20 lg:py-32">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <h1 className="text-6xl lg:text-8xl font-bold text-secondary mb-4">404</h1>
          <h2 className="text-2xl lg:text-3xl font-semibold text-secondary mb-6">Page Not Found</h2>
          ...
          <div className="mt-12 text-center">
            <p className="text-slate-500 mb-4">Need help? Contact our support team:</p>
            <a 
